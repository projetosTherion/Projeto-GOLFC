    ...
    <div className='flex  justify-center mt-[1%]'>
      ...
      <div className='flex mr-[5%] justify-end font-Carbona text-center text-white'>
        <button className='flex  text-customResponsiveHeader' onClick={handleToggle}>
          Ver mais <span className='mt-[5%] ml-[0%]  text-Verde-Gol'><IoIosArrowDropdownCircle /></span>
        </button>
      </div>
    </div>
    <div className='flex mt-[2%] justify-center'>
    <div className='flex justify-between font-tuskerGrotesk rounded-lg md:w-[60%] w-[80%] bg-[#D9D9D9]'>
      
     <span className='ml-[5%] mb-[5%] md:text-customResponsiveConteudo text-customResponsiveTitulo mt-[5%]'>PROPAGANDA PLACEHOLDER</span>
     <span className="font-bold relative">
    <div className="absolute top-1 left-1/2 transform -translate-x-1/2 h-[90%] w-[2px] bg-[#3C2290]  "></div>
  </span>
     <span className='mr-[5%] mt-[5%] mb-[5%] md:text-customResponsiveConteudo text-customResponsiveTitulo'>CONVITE AMIGOS(PLACEHOLDER)</span>
    </div></div>
    </div>
  );
};
