...
const Login = () => {
  return (
    <div className="h-screen bg-Login flex items-center justify-center bg-cover relative">
      {/* Imagem acima do quadrado */}
      <img
        src={Logo}
        alt="Logo GOL"
        className="absolute top-[6rem] left-1/2 transform -translate-x-1/2 w-32 h-32 "
      />
      
      <div className="w-[386px] h-[452px] bg-blue-950 bg-opacity-70 rounded-lg border border-gray-300 p-4 flex flex-col items-center backdrop-blur-md">
